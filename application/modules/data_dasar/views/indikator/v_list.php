                            ...
                            <tr>
                                ...
                                <?php for ($i=$this->portal->selected_periode()->TAHUN_AWAL; $i <= $this->portal->selected_periode()->TAHUN_AKHIR; $i++) { ?>
                                 ...
                                 <td class="text-center">
                                    <button onclick="edit_indikator(<?php echo $row['ID']; ?>)" class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="">Edit</button>
                                    <button onclick="delete_indikator(<?php echo $row['ID']; ?>)" class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="">Delete</button>
                                 </td>
                                 <!-- <td class="text-center">
