...
class Rpjmd extends CI_Controller {
    ...
    public function tambah($id){
        ...
        $data['ceklist'] = $this->m_rpjmd_data->ceklist_indikator($like,$urusan->URUSAN_ID);
    ...
    public function ceklist_indikator($id){
        ...
        $data['list_items'] = $this->m_rpjmd_data->ceklist_indikator($like, $urusan->URUSAN_ID);
        $this->load->view('rpjmd/indikator/v_indikator_list', $data);
    }
    ...
    public function simpan() {
        ...
        if($this->form_validation->run()) {
            ...
            $query = $this->m_rpjmd_data->insert_indikator($program,$kegiatan, $indikators);
