        ...
        <div id="general-info" class="section general-info">
            <div class="info">
                <div class="d-flex justify-content-between line">
                    <h6 class="">RPJMD MISI</h6>
                    <div class="float-right">
                       <button class="btn btn-primary mb-2 mr-2" onclick="tambah_misi()"><i data-feather="plus-circle"></i> tambah</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function tambah_misi(){
        load('rpjmd/misi/tambah/', '#contents');       
    }
</script>