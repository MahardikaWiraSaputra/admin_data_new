                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_program">
							<div class="form-group row mb-2">
								...
								<?php
								echo form_dropdown('f_skpd', $filter_skpd, '', 'id="f_skpd", class="form-control select2", onchange="get_urusan()",disabled="disabled"'); 
								?>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<div id="frmurusan">
									<?php echo form_dropdown('f_urusan',$filter_urusan, '', 'id="f_urusan", class="form-control select2",disabled="disabled"'); ?>
									</div>
								</div>
							</div>
