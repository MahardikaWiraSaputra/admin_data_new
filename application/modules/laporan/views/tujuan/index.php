        ...
        <div id="general-info" class="section general-info">
            <div class="info">
                <div class="d-flex justify-content-between line">
                    <h6 class="">CASCADING RPJMD</h6>
                    <div class="float-right" style="display: none">
                       <button class="btn btn-primary mb-2 mr-2" onclick="tambah_tujuan()"><i data-feather="plus-circle"></i> CETAK LAPORAN</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	function get_items(page){
	    ...
	    $.post(site+'laporan/tujuan/daftar', {
