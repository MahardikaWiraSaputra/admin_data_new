...
class Laporan_renstra extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('laporan/Laporan_renstra/index', $data);
    }
    ...
    public function daftar(){
        ...
        foreach($data['list_program'] as $key =>$val){
            ...
            $kegiatan = $this->m_renstra_program->get_list_kegiatan($val['ID']);

            foreach ($kegiatan as $res) {
                $indikator_kegiatan = $this->m_renstra_program->get_list_kegiatan_indikator($res['ID']);
        ...
        $this->load->view('laporan/Laporan_renstra/v_list', $data );
    }
