           ...
           <table class="table table-bordered table-hover table-condensed mb-4">
              <thead>
                 <tr>
                    ...
                    <th colspan="2" rowspan="2">URAIAN PROGRAM / INDIKATOR PROGRAM</th>
              ...
              <tbody>
                 ...
                 <tr>
                    ...
                    <td class="text-center">
                       <ul class="table-controls">
                          <li><a href="javascript:void(0);" onclick="remove_indikator(<?php echo $sub_items['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                       </ul>
                    </td>
                 </tr>
                 <?php endforeach;?>
