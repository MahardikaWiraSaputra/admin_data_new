                	...
                	<div class="col-lg-12 mx-auto">
			            <div id="form_sasaran">
							<div class="form-group row mb-2">
								<?php echo form_label('Sasaran Pemerintah Daerah', 'f_sasaran', array('class' => 'col-xl-3 col-sm-3 col-sm-3 col-form-label')); ?>
								<div class="col-xl-9 col-lg-9 col-sm-9">
									<?php echo form_textarea(['name' => 'f_sasaran', 'id' => 'f_sasaran', 'class' => 'form-control', 'rows' =>'1', 'value' => $detail->SASARAN]); ?>
								</div>
							</div>
						</div>	
                	</div>
...
<script type="text/javascript">
	...
	function get_indikator(page){
	    $.post(site+'rpjmd/sasaran/ceklist_indikator', {
	...
	function simpan_indikator(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>rpjmd/sasaran/simpan_indikator",
