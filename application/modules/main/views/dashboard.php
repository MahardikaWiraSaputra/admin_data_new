<div class="container-fluid dashboard-default-sec">
   <div class="row" style="display: none">
            ...
            <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
               <div class="card profile-greeting">
                  ...
                  <div class="card-body text-center p-t-0">
                     <h3 class="font-light">Selamat Datang, <?php echo $this->ion_auth->user()->row()->full_name; ?></h3>
                     <p>Intro tentang data</p>
                     <button class="btn btn-light">Jelajahi</button>
                  </div>
                  <div class="confetti">
            ...
            <div class="col-xl-4 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
               <div class="card income-card card-primary">
                  <div class="card-body text-center">
                     ...
                     <h5><?php echo num_format($total_indikator['total']);?></h5>
                     <p>Total Data</p>
            ...
            <div class="col-xl-4 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
               <div class="card income-card card-secondary">
                  <div class="card-body text-center">
                     ...
                     <h5><?php echo($total_urusan['total_urusan']);?></h5>
                     <p>Urusan</p>
            ...
            <div class="col-xl-4 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
               <div class="card income-card card-secondary">
                  <div class="card-body text-center">
                     ...
                     <h5><?php echo num_format($total_terisi);?> %</h5>
                     <p>Tingkat Keterisian</p>
                     <a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i class="toprightarrow-secondary fa fa-arrow-up me-2"></i>90.54% </a>
                     <div class="parrten">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                           <g>
      ...
      <div class="col-xl-8 box-col-12 des-xl-100" style="display: none">
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body p-0">
                     ...
                     <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="sell-overview">
                            <div class="card"> <div class="card-header"> <div class="header-top d-sm-flex align-items-center"> <h5> Sell Overview </h5> <div class="center-content" > <p class="d-flex align-items-center"> <i class="toprightarrow-primary fa fa-arrow-up me-2" > </i> 86% Growth </p> </div> <div class="setting-list"> <ul class="list-unstyled setting-option"> <li><div class="setting-primary"><i class="icon-settings"></i></div></li> <li><i class="view-html fa fa-code font-primary"></i></li> <li><i class="icofont icofont-maximize full-card font-primary"></i></li> <li><i class="icofont icofont-minus minimize-card font-primary"></i></li> <li><i class="icofont icofont-refresh reload-card font-primary"></i></li> <li><i class="icofont icofont-error close-card font-primary"> </i></li> </ul> </div> </div> </div> <div class="card-body p-0"> <div id="chart-dashbord"></div> </div> </div>
                          </code></pre>
                     </div>
                  </div>
               </div>
      ...
      <div class="col-xl-4 box-col-12 des-xl-100" style="display: none">
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body p-0">
                     ...
                     <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="user-activations">
                            <div class="card"> <div class="card-header"> <div class="header-top d-sm-flex align-items-center"> <h5>User Activations</h5> <div class="center-content"> <p>Yearly User 24.65k</p> </div> <div class="setting-list"> <ul class="list-unstyled setting-option"> <li> <div class="setting-primary"> <i class="icon-settings"></i> </div> </li> <li> <i class="view-html fa fa-code font-primary"></i> </li> <li> <i class="icofont icofont-maximize full-card font-primary"></i> </li> <li> <i class="icofont icofont-minus minimize-card font-primary"></i> </li> <li> <i class="icofont icofont-refresh reload-card font-primary"></i> </li> <li> <i class="icofont icofont-error close-card font-primary"></i> </li> </ul> </div> </div> </div> <div class="card-body p-0"> <div id="user-activation-dash-2"></div> </div> </div>
                          </code></pre>
                     </div>
                  </div>
               </div>
               ...
               <div class="card trasaction-sec">
                  ...
                  <div class="card-body p-0">
                     ...
                     <div class="code-box-copy">
                        ...
                        <pre>
                           <code class="language-html" id="transaction">
                              <div class="card trasaction-sec"> 
                                 <div class="card-header"> 
                                    <div class="header-top d-sm-flex align-items-center"> 
                                       <h5>Transaction</h5> 
          ...
          <div class="card">
              ...
              <form class="search-form">
                ...
                <div class="form-group mb-0">
                  <div class="input-group">
                    ...
                    <input class="form-control-plaintext" type="search" placeholder="Cari Data SKPD mu">
                  </div>
                </div>
              </form>
            </div>
            <div class="card-body">
              <ul class="nav nav-tabs search-list" id="top-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="all-link" data-bs-toggle="tab" href="#all-links" role="tab" aria-selected="true">
                    <i class="icon-target"></i>Semua Data </a>
                  <div class="material-border"></div>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="image-link" data-bs-toggle="tab" href="#image-links" role="tab" aria-selected="false">
                    <i class="icon-image"></i>Data Indikator </a>
                  <div class="material-border"></div>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="video-link" data-bs-toggle="tab" href="#video-links" role="tab" aria-selected="false">
                    <i class="icon-video-clapper"></i>Data Raw </a>
                  <div class="material-border"></div>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="map-link" data-bs-toggle="tab" href="#map-links" role="tab" aria-selected="false">
                    <i class="icon-map-alt"></i>Data Aplikasi </a>
                  <div class="material-border"></div>
                </li>
              </ul>
