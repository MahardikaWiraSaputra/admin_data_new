                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <ul class="table-controls">
                                <li><a href="javascript:void(0);" onclick="edit_overlay(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Edit"><i data-feather="edit" class="text-primary"></i></a></li>
                                <li><a href="javascript:void(0);" onclick="delete_overlay(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                            </ul>
                        </td>
                    </tr>
                    <?php endforeach;?>
...
<script type="text/javascript">
    ...
    function detail_overlay(id){
        load('analisa/overlay/detail/'+id, '#contents');
    }

    function edit_overlay(id){
        load('analisa/overlay/edit/'+id, '#contents');
    }
    ...
    function delete_overlay(id) {
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url  : "<?php echo base_url()?>analisa/overlay/delete/"+id,
                    dataType: "JSON",
                    type: "POST",
                            ...
                            swal({
                              ...
                              timer: 1500
                                ...
                                if (result.dismiss === Swal.DismissReason.timer) {
                                    load('analisa/overlay/index', '#contents');
                                }
                            });
                        }
                        else {
