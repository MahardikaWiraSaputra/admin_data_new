            ...
            <div class="info">
	        	...
	        	<form id="form_indikator">
					<div class="form-group row mb-2">
						<?php echo form_label('Judul Analisa Overlay', 'f_indikator_y', array('class' => 'col-xl-2 col-sm-2 col-sm-2 col-form-label')); ?>
						<div class="col-xl-10 col-lg-10 col-sm-10">
							<input type="text" class="form-control input" name="judul" id="judul" placeholder = "Judul analisa overlay">
						</div>
					</div>
					<div class="form-group row mb-2">
					...
					<div class="form-group row mb-2">
						<?php echo form_label('INDIKATOR TAMBAHAN', 'f_indikator_tambahan', array('class' => 'col-xl-2 col-sm-2 col-sm-2 col-form-label')); ?>
						<div class="col-xl-10 col-lg-10 col-sm-10">
							<select class="form-control select2" name="indikator_tambahan" id="indikator_tambahan">
								<?php foreach($list_indikator as $data):?>
									<option value="<?=$data['ID']?>"><?=$data['INDIKATOR']?></option>
								<?php endforeach;?>
							</select>
...
<script>
	...
	function simpan_indikator(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>analisa/overlay/simpan",
