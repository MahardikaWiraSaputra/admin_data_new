	        	...
	        	<form id="form_indikator">
					<div class="form-group row mb-2">
						...
						<div class="col-xl-10 col-lg-10 col-sm-10">
							<input type="text" class="form-control input" name="judul" id="judul" placeholder = "Judul analisa rasio">
						</div>
					</div>
					<div class="form-group row mb-2">
					...
					<div class="form-group row mb-2">
						...
						<div class="col-xl-10 col-lg-10 col-sm-10">
							<input type="text" class="form-control input" name="f_per" id="f_per" placeholder = "Contoh : 100.000">
						</div>
					</div>
...
<script>
	...
	function simpan_indikator(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>analisa/rasio/simpan",
