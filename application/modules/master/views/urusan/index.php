        ...
        <div id="general-info" class="section general-info">
            <div class="info">
            	<div class="d-flex justify-content-between">
                	<h6 class="">MASTER URUSAN</h6>
	                <div class="float-right">
                        <button class="btn btn-primary mb-2 mr-2" onclick="tambah_urusan()"><i data-feather="plus-circle"></i> tambah</button>
	                </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	function get_items(page){
	    ...
	    $.post(site+'master/urusan/daftar', {
