        ...
        <div id="general-info" class="section general-info">
            <div class="info">
                <div class="d-flex justify-content-between">
                    <h6 class="">MASTER SKPD</h6>
                    <div class="float-right">
                        <button class="btn btn-primary mb-2 mr-2" onclick="tambah_skpd()"><i data-feather="plus-circle"></i> tambah</button>
                    </div>
                </div>
            </div>
        </div>
