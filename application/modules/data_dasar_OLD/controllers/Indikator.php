...
class Indikator extends CI_Controller {
    ...
    public function simpan() {
        ...
        if($this->form_validation->run()) {
            ...
            $data['INDIKATOR'] = htmlspecialchars($this->input->post('f_indikator'));
            $data['SATUAN'] = htmlspecialchars($this->input->post('f_satuan'));
            $data['TIPE_DATA'] = htmlspecialchars($this->input->post('f_kategori'));

            if ($this->input->post('is_rpjmd')) { 
               $data['RPJMD'] = htmlspecialchars($this->input->post('is_rpjmd'));
            }
            if ($this->input->post('is_renstra')) {
               $data['RENSTRA'] = htmlspecialchars($this->input->post('is_renstra'));
            }
            if ($this->input->post('is_sdgs')) {
               $data['SDGS'] = htmlspecialchars($this->input->post('is_sdgs'));
            }
            if ($this->input->post('is_spm')) {
               $data['SPM'] = htmlspecialchars($this->input->post('is_spm'));
            }
