	                    ...
	                    <div class="col-sm-12">
	                        <div class="form-group row mb-2">
	                            ...
	                            <div class="col-xl-4 col-lg-4 col-sm-4">
									<?php echo form_dropdown('urusan', $filter_urusan, '', 'id="urusan", class="form-control select2", style="width:100%", onchange="filter_sasaran(), get_items()"'); ?>
	                            </div>
	                        </div>
                            <div class="form-group row mb-2">
                                <label for="urusan" class="col-xl-2 col-sm-2 col-sm-2 col-form-label">Tujuan</label>
                                <div class="col-xl-6 col-lg-6 col-sm-6">
                                    <div id="filter_sasaran">
                                        <?php echo form_dropdown('sasaran', '', '', 'id="sasaran", class="form-control select2", style="width:100%"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function filter_sasaran(){
        var urusanID = $('select[id="urusan"]').val();
        $("#filter_sasaran").html('<i class="fa fa-refresh fa-spin"></i>');
        load('spm/filter_sasaran/'+urusanID, '#filter_sasaran');
    }
</script>