        ...
        <div id="general-info" class="section general-info">
            <div class="info">
            	<div class="d-flex justify-content-between">
                	<h6 class="">SPM SASARAN</h6>
	                <div class="float-right">
	                	<button class="btn btn-primary mb-3 mr-2" onclick="tambah_sasaran()"><i data-feather="plus-circle"></i> tambah</button>
	                </div>
                </div>
	            <form>
	                <div class="row">
