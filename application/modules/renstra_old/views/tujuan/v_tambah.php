			            ...
			            <form id="form_tujuan">
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_dropdown('f_misi', $misi_list, '', 'id="f_misi", class="form-control select2"'); ?>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_dropdown('f_tujuan_rpjmd', $tujuan_rpjmd, '', 'id="f_tujuan_rpjmd", class="form-control select2"'); ?>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_tujuan', 'id' => 'f_tujuan', 'class' => 'form-control', 'rows' =>'3', 'placeholder' => 'Uraian Tujuan']); ?>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function simpan_tujuan(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>renstra/tujuan/simpan",
