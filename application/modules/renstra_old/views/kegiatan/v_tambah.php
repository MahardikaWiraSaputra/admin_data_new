							   ...
							   <div class="col-xl-10 col-lg-10 col-sm-10">
							      <?php
							         if (!$this->ion_auth->in_group(array(1,2))){
							             echo form_dropdown('skpd', $this->portal->get_my_skpd(), '', 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program()"');
							         }
							         else {
							         
							             echo form_dropdown('skpd', $this->portal->get_list_skpd(), '', 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program()"');
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-xl-10 col-lg-10 col-sm-10">
									<div id="bidang_program">
										<?php echo form_dropdown('f_program', '', '', 'id="f_program", class="form-control select2", style="width:100%"'); ?>
									</div>
	                            </div>
	                        </div>
...
<script type="text/javascript">
	...
	function simpan_program(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>renstra/kegiatan/simpan",
