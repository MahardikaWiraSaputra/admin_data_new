                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_kegiatan">
							   ...
							   <div class="col-xl-10 col-lg-10 col-sm-10">
							      <?php
							         if (!$this->ion_auth->in_group(array(1,2))){
							             echo form_dropdown('skpd', $this->portal->get_my_skpd(), $detail->SKPD_ID, 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program()"');
							         }
							         else {
							         
							             echo form_dropdown('skpd', $this->portal->get_list_skpd(),  $detail->SKPD_ID, 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program()"');
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-xl-10 col-lg-10 col-sm-10">
									<div id="bidang_program">
										<?php echo form_dropdown('f_program', $program_list, $detail->PROGRAM_ID, 'id="f_program", class="form-control select2", style="width:100%"'); ?>
									</div>
	                            </div>
	                        </div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_kegiatan', 'id' => 'f_kegiatan', 'class' => 'form-control', 'rows' =>'3','value' => $detail->KEGIATAN, 'placeholder' => 'Indikator Kinerja Program SKPD']); ?>
								</div>
							</div>
