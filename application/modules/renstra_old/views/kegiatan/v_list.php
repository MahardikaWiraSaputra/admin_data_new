            ...
            <table class="table table-bordered table-hover table-condensed mb-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=""><a href="javascript:void(0)" onclick="detail_kegiatan(<?php echo $row['ID']; ?>)"><?php echo $row['KEGIATAN']; ?></a></td>
                        <td class="text-center">
                                <ul class="table-controls">
                                    <li><a href="javascript:void(0);" onclick="edit_kegiatan(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Edit"><i data-feather="edit" class="text-primary"></i></a></li>
                                    <li><a href="javascript:void(0);" onclick="delete_kegiatan(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                                </ul>
                            </td>
                    </tr>
                    <?php endforeach;?>
