...
<div class="row mb-4">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" id="misi-terkait">
        <div id="general-info" class="section general-info">
            <div class="info">
                <h6 class="">Unit Kerja Berkaitan dengan Visi</h6>
                <div class="row">
                    <div class="col-lg-12 mx-auto">
                        <div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
        <div class="section general-info">
            <div class="info">
            	<form id="form_skpd_visi">
        		<input type="hidden" name="f_visi" value="<?php echo $detail->ID;?>">
				<div class="table-responsive">
		            <table class="table table-bordered table-hover table-condensed mb-4">
		                <thead>
		                    <tr>
		        ...
		        <div class="form-group row my-4">
					<label class="col-xl-3 col-sm-3 col-sm-3 col-form-label"></label>
					<div class="col-xl-9 col-lg-9 col-sm-9">
						<button type="button" class="btn btn-primary my-2 mr-2" onclick="simpan_skpd_visi()" >Simpan Data</button>
					</div>
				</div>
		   		</form>
            </div>
...
<script type="text/javascript">
                    ...
                    swal({
				      ...
				      timer: 1500
					    ...
					    if (result.dismiss === Swal.DismissReason.timer) {
							load('renstra/visi/index', '#contents');
					    }
					});
                }
                else {
	...
	function delete_visi(id) {
		swal({
        	...
        	if (result.value) {
          		$.ajax({
             		url  : "<?php echo base_url()?>renstra/visi/delete/"+id,
                	dataType: "JSON",
                	type: "POST",
                	success: function(response){
		                if(response.success == true) {
	...
	function simpan_skpd_visi(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>renstra/visi/simpan_visi_indikator",
            data: $("#form_skpd_visi").serializeArray(),
            dataType: "JSON",
            success: function(response){
