...
class Program extends CI_Controller {
    ...
    public function list(){
        ...
        $data['total_items'] = $this->m_renstra_program->get_list_total($where, $where_urusan, $like)->row('count');
        $data['list_items'] = $this->m_renstra_program->get_list_data($param, $where_urusan, $like, $limit, $offset);
    ...
    public function tambah_indikator($id){
        ...
        $data['sasaran_list'] = $this->m_renstra_program->get_sasaran_dropdown();
        $data['detail'] = $this->m_renstra_program->detail($id);
        // $data['ceklist'] = $this->m_renstra_program->ceklist_indikator($urusan->URUSAN_ID);
