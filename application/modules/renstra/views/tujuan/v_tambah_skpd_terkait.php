            ...
            <div class="info">
		        ...
		        <div class="form-group row my-4">
					...
					<div class="col-xl-9 col-lg-9 col-sm-9">
						<button type="button" class="btn btn-primary my-2 mr-2" onclick="simpan_skpd_tujuan()" >Simpan Data</button>
					</div>
				</div>
		   		</form>
            </div>
...
<script type="text/javascript">
	...
	function simpan_skpd_tujuan(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>renstra/tujuan/simpan_tujuan_skpd",
            data: $("#form_skpd_tujuan").serializeArray(),
            dataType: "JSON",
            success: function(response){
