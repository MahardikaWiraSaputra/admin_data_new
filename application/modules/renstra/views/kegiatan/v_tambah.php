			            ...
			            <form id="form_program">
			            	...
			            	<div class="form-group row">
							   ...
							   <div class="col-xl-10 col-lg-10 col-sm-10">
							      <?php
							      	echo form_dropdown('skpd', $filter_skpd, '', 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program()"');
							         ?>
							   </div>
							</div>
	                        <div class="form-group row">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_kegiatan', 'id' => 'f_kegiatan', 'class' => 'form-control', 'rows' =>'3', 'placeholder' => 'Indikator Kegiatan SKPD']); ?>
								</div>
							</div>
