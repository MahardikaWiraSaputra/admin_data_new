	                    ...
	                    <div class="col-sm-5">
	                   	 <div class="form-group row">
							   ...
							   <div class="col-xl-9 col-lg-9 col-sm-9">
							      <?php
							             echo form_dropdown('skpd', $filter_skpd, '', 'id="skpd", class="form-control select2", style="width:100%", onchange="get_program(), get_items()"');
							         ?>
							   </div>
							</div>
	                        <div class="form-group row">
...
<script type="text/javascript">
	...
	function get_items(page){
	    ...
	    $.post(site+'renstra/kegiatan/daftar', {
