                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_sasaran">
							...
							<div class="form-group row mb-2">
								...
								<?php 
								echo form_dropdown('f_skpd', $filter_skpd, $detail->SKPD_ID, 'id="f_skpd", class="form-control select2", onchange="get_urusan()"'); 
								?>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<div id="frmurusan">
										<?php echo form_dropdown('f_urusan', $filter_urusan, $detail->URUSAN_ID, 'id="f_urusan", class="form-control select2"'); ?>
									</div>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_sasaran', 'id' => 'f_sasaran', 'class' => 'form-control', 'rows' =>'3', 'placeholder' => 'Uraian Sasaran','value'=>$detail->SASARAN]); ?>
								</div>
							</div>
