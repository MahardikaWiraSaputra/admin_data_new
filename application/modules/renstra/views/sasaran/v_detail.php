...
<div class="row mt-3 mb-3">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 mb-3 mt-3" id="sasaran-terkait">
        <div id="general-info" class="section general-info">
            <div class="info">
	...
	<div class="col-xl-12 col-lg-12 col-md-12" id="indikator-terkait">
        <div id="general-info" class="section general-info">
            <div class="info">
            	<div class="d-flex justify-content-between">
...
<script type="text/javascript">
	...
	function list_indikator(){
	    ...
	    $.post(site+'renstra/sasaran/list_indikator/'+id, {
