                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <ul class="table-controls">
                                ...
                                <li><a href="javascript:void(0);" onclick="hapus_indikator(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                            </ul>
                        </td>
                    </tr>
                    <?php endforeach;?>
...
<script type="text/javascript">
    ...
    function update_status(id, tipe, value) {
        swal({
            title: 'Apakah anda yakin?',
            text: "merubah kodefikasi data indikator",
            type: 'warning',
            showCancelButton: true,
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.success == true) {
                            swal({
                              title: 'Sukses',
                              text: "Kodefikasi berhasil diubah",
                              type: 'success',
                              padding: '2em',
                              showConfirmButton: false, 
                              timer: 1500
