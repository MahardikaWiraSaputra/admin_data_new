...
<div class="row mt-2">
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
        <div id="general-info" class="section general-info">
            <div class="info">
            	<h3>RPJMD Capaian Indikator Pemerintah Daerah</h>
            </div>
        </div>
    </div>
</div>
                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_program">
							<div class="form-group row mb-2">
								<?php echo form_label('Urusan Pemerintah Daerah', 'f_program', array('class' => 'col-xl-2 col-sm-2 col-sm-2 col-form-label')); ?>
