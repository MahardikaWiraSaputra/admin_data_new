...
<div class="row mt-2">
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
        <div id="general-info" class="section general-info">
            <div class="info">
            	<h3>RPJMD Tujuan Pemerintah Daerah</h>
            </div>
        </div>
    </div>
</div>
                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_tujuan">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_tujuan', 'id' => 'f_tujuan', 'class' => 'form-control', 'rows' =>'3', 'placeholder' => 'Tujuan Pemerintah Daerah']); ?>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function simpan_tujuan(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>rpjmd/tujuan/simpan",
