...
<div class="row mb-4">
        ...
        <div class="section general-info">
            <div class="info">
                <div class="d-flex justify-content-between">
                	<h6 class="">Tujuan Pemerintah Daerah</h6>
                    ...
                    <div class="col-lg-12 mx-auto">
                    	<form id="form_visi">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_dropdown('f_misi', $misi_list, $detail->MISI_ID, 'id="f_misi", class="form-control select2", disabled="disabled"'); ?>
								</div>
							</div>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing" id="sasaran-terkait">
        <div id="general-info" class="section general-info">
            <div class="info">
                <h6 class="">Keterkaitan Dengan Sasaran Pemda</h6>
                <div class="row">
                    <div class="col-lg-12 mx-auto">
                        <div class="row">
