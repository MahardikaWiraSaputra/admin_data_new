            ...
            <table class="table table-bordered table-hover table-condensed mb-4">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">TARGET / INDIKATOR</th>
                ...
                <tbody>
                    <?php $k='0' ; foreach($item_target as $key => $row): $k++; ?>
                    <tr style="background: #f2f2f2; font-weight: 500">
                        <td align="center"><?php echo $k; ?></td>
                        <td class="mailbox-subject" colspan="<?php echo 2021-2010; ?>"><?php echo $row['TARGET']; ?></td>
                    </tr>
                    <?php if(isset($list_items[$row['TARGET_ID']])) { ?>
                    <?php $s='0'; foreach ($list_items[$row['TARGET_ID']] as $sub) : $s++; ?>
                        <tr>
                            ...
                            <?php for ($i=2011; $i < 2021; $i++) { ?>
                                ...
                                <?php } else { ?>
                                    <td class="text-center"><a id="tambah_val" href="javascript:void(0)" onclick="tambah_value()" class="btn btn-xs"><i class=" fa fa-plus-square-o"></i></a></td>
                                <?php } ?>
