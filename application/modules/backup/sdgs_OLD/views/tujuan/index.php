                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="urusan" class="col-xl-4 col-sm-4 col-sm-4 col-form-label">Pilar Pembangunan</label>
                            <div class="col-xl-8 col-lg-8 col-sm-8">
								<div id="bidang_urusan">
									<?php 
										if (!$this->ion_auth->in_group(array(1,2))){
											echo form_dropdown('pilar', $this->portal->get_my_urusan(), '', 'id="pilar", class="form-control select2", style="width:100%", onchange="get_items()"'); 
										}
										else {
