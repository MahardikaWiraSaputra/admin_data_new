...
<div class="row mb-4">
    ...
    <div class="col-xl-6 col-lg-6 col-sm-6 text-right">
        <button onclick="tambah_tujuan();" class="btn btn-secondary mr-2"><span class="feather-sub"><i data-feather="plus"></i></span> Tambah Data</button>
    </div>
</div>
<div class="row">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <ul class="table-controls">
                                <li><a href="javascript:void(0);" onclick="edit_tujuan(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Edit"><i data-feather="edit" class="text-primary"></i></a></li>
                                <li><a href="javascript:void(0);" onclick="delete_tujuan(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                            </ul>
                        </td>
                    </tr>
                    <?php endforeach;?>
...
<script type="text/javascript">
    ...
    function detail_tujuan(id){
        load('sdgs/tujuan/detail/'+id, '#contents');
    }

    function edit_tujuan(id){
        load('sdgs/tujuan/edit/'+id, '#contents');
    }
    ...
    function delete_tujuan(id) {
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url  : "<?php echo base_url()?>sdgs/tujuan/delete/"+id,
                    dataType: "JSON",
                    type: "POST",
