...
<div class="row mb-4">
    ...
    <div class="col-xl-6 col-lg-6 col-sm-6 text-right">
        <button onclick="tambah_target();" class="btn btn-secondary mr-2"><span class="feather-sub"><i data-feather="plus"></i></span> Tambah Data</button>
    </div>
</div>
<div class="row">
            ...
            <table class="table table-bordered table-hover table-condensed mb-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="mailbox-subject"><?php echo $row['TARGET']; ?></td>
