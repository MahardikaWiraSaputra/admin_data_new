                	...
                	<div class="col-lg-12 mx-auto">
			            <form id="form_sasaran">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_sasaran', 'id' => 'f_sasaran', 'class' => 'form-control', 'rows' =>'3', 'placeholder' => 'Sasaran Pemerintah Daerah']); ?>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function simpan_sasaran(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>rpjmd/sasaran/simpan",
