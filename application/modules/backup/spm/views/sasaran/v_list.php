            ...
            <table class="table table-bordered table-hover table-condensed mb-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="mailbox-subject"><?php echo $row['URUSAN']; ?></td>
                        <td class="mailbox-subject"><?php echo $row['SASARAN']; ?></td>
                        <td class="text-center">
                            <ul class="table-controls">
                                <li><a href="javascript:void(0);" onclick="edit_sasaran(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Edit"><i data-feather="edit" class="text-primary"></i></a></li>
                                <li><a href="javascript:void(0);" onclick="delete_sasaran(<?php echo $row['ID']; ?>)" data-toggle="tooltip" data-placement="top" title="Delete"><i data-feather="trash" class="text-danger"></i></a></li>
                            </ul>
                        </td>
                    </tr>
                    <?php endforeach;?>
...
<script type="text/javascript">
    ...
    function tambah_sasaran(){
        load('spm/sasaran/tambah/', '#contents');
    }

    function detail_sasaran(id){
        load('spm/sasaran/detail/'+id, '#contents');
    }

    function edit_sasaran(id){
        load('spm/sasaran/edit/'+id, '#contents');
    }
    ...
    function delete_sasaran(id) {
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url  : "<?php echo base_url()?>spm/sasaran/delete/"+id,
                    dataType: "JSON",
                    type: "POST",
