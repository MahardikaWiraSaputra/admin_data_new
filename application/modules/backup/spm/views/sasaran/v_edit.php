                    	...
                    	<form id="form_spm_sasaran">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-4 col-lg-4 col-sm-4">
									<?php echo form_dropdown('f_urusan', $form_urusan, $detail->URUSAN_ID, 'id="f_urusan", class="form-control select2"'); ?>
								</div>
							</div>
							...
							<div class="form-group row mb-2">
								...
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<?php echo form_textarea(['name' => 'f_sasaran', 'id' => 'f_sasaran', 'class' => 'form-control', 'rows' =>'2', 'value' => $detail->SASARAN]); ?>
								</div>
							</div>
							<div class="form-group row my-4">
								<label class="col-xl-2 col-sm-2 col-sm-2 col-form-label"></label>
								<div class="col-xl-10 col-lg-10 col-sm-10">
									<button type="button" class="btn btn-primary my-2 mr-2" onclick="update_sasaran()" >Simpan Data</button>
								</div>
							</div>
						</form>
                    </div>
...
<script type="text/javascript">
	...
	function update_sasaran(){
        $.ajax({
            type: "POST",
            url  : "<?php echo base_url()?>spm/sasaran/update",
