            ...
            <table class="table table-bordered table-condensed mb-4">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <?php for ($i=$this->portal->selected_periode()->TAHUN_AWAL; $i <= $this->portal->selected_periode()->TAHUN_AKHIR; $i++) { ?>
                        <input type="hidden" class="form-control" name="f_desa[]" id="f_desa" value="<?php echo $rows['DESA']; ?>">
                        <input type="hidden" class="form-control" name="f_tahun[]" id="f_tahun" value="<?php echo $i; ?>">
                        <?php if (isset( $rows[$i])) {?>
                            <td><input type="text" class="form-control" name="f_capaian_desa[]" id="f_capaian_desa" value="<?php echo $rows[$i];?>"></td>
                            <?php } else { ?>
                            <td><input type="text" class="form-control" name="f_capaian_desa[]" id="f_capaian_desa" value="0"></td>
                            <?php } ?>
                        <?php } ?>
                  </tr>
                  <?php endforeach; ?>
